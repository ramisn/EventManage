...
(function ($) {
  ...
  $.widget("thomaskahn.smoothDivScroll", {
    ...
    options: {
      ...
      // Hotspot scrolling
      hotSpotScrolling: false, // Boolean
      ...
      autoScrollingInterval: 30, // Milliseconds
    ...
    _create: function () {
      ...
      *****************************************/
      ...
      /*****************************************
      SET UP EVENTS FOR STOP/START AUTO SCROLL ONHOVER
      *****************************************/
      // Check the mouse position and decide
      // whehter mouse is over/out inside the scrollable area
      el.data("scrollableArea").bind("mouseover", function (e) {
        self.stopAutoScrolling();
      });
    ...
    **********************************************************/
    recalculateScrollableArea: function () {
      ...
      //alert(el.data("scrollableArea").width());
